        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Report neighborhood concern</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Airbnb.org: disaster relief</a></li>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center mt-4 md:mt-0 space-x-6">
              ...
              <button className="text-sm text-gray-800">$ USD</button>
